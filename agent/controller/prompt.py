...
def build_prompt(
    ...
    system_prompt = (
        ...
        # ■■■ 2. 思考プロセス (Mandatory Thinking Process) ■■■
        """
        **思考と行動に関する厳格な指示**\n
    ...
    ユーザーリクエスト: これは最終的な目的であり、常に表示されます。\n
        ...
        # ■■■ 5. 成功のためのガイドライン (Success Guidelines) ■■■
        """
    成功するための役立つヒント：\n
        ...
        # ■■■ 6. ブラウザ操作ルール (Browser Operation Rules) ■■■
        """
    ブラウザを使用して Web を閲覧する際は、以下のルールに厳密に従ってください。\n
        ...
        # ■■■ 7. 入力候補・動的要素への対処 (Input Suggestions & Dynamic Elements) ■■■
        """
    ...
    """
        ...
        "    **初回応答**では、以下のようにタスク達成のための大まかなプランニングをし、`actions` は空配列、`complete:false` として出力する。\n"
        "    例:\n"
        "    1. 調べる\n"
        "    2. 複数のサイトを見る\n"
        "    3. まとめる\n"
        ...
        # ■■■ 10. アクションヘルパー関数 (Action Helper Functions) ■■■
